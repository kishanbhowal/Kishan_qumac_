...
#for q_no in [2]:
    ...
    def ext_BW(freq, ydata, plot=False):
        ...
        if plot:
            ...
            plt.title(f'Cavity response Real for Cavity {(2*q_no+5)%12} Qubit {q_no}')
    ...
    ip = "TCPIP0::192.168.0.27::hislip0::INSTR"
    #ip = "TCPIP0::192.168.0.27::5025::SOCKET"
    #print(kna.query("*IDN?"))
...
time_taken_seconds = time_taken- time_taken//60
print(f"Total Time Taken {time_taken//60}m {time_taken_seconds}s")