...
f_min = q_IF[qe[-1]] * 0.9#38.5 * u.MHz#132 * u.MHz #129.13 12.171
f_max = q_IF[qe[-1]] * 1.1#132.5 * u.MHz # -91.4

# f_min = 115 * u.MHz#38.5 * u.MHz#132 * u.MHz #129.13 12.171
# f_max = 125 * u.MHz#132.5 * u.MHz # -91.4
...
with program() as qubit_spec:
    ...
    with for_(n, 0, n < 10000, n + 1):
        with for_(f, f_min, f < f_max, f + df):
            ...
            # play("const" * amp(0.2), qe_test, duration=pulse_duration)
            align(rr, qe)
