...
f_min = -300 * u.MHz#141.52 * u.MHz#38.5 * u.MHz#132 * u.MHz #129.13 12.171
f_max = 300 * u.MHz#141.58 * u.MHz#132.5 * u.MHz # -91.4
...
with program() as qubit_spec:
    ...
    with for_(n, 0, n < 10000, n + 1):
        with for_(f, f_min, f < f_max, f + df):
            reset_frame(rr)         # added for testing remove asap
            reset_frame(qe)
