...
# Single QUA script generated at 2025-03-20 22:29:34.442645
...
with program() as prog:
    ...
    v78 = declare(fixed, )
    v79 = declare(fixed, )
    update_frequency("q5", -44760329.0, "Hz", False)
    with for_(v1,0,(v1<10000.0),(v1+1)):
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v8, "out1"), demod.full("integW_minus_sin", v9, "out1"))
        r4 = declare_stream()
        save(v8, r4)
        r25 = declare_stream()
        save(v9, r25)
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v10, "out1"), demod.full("integW_minus_sin", v11, "out1"))
        r5 = declare_stream()
        save(v10, r5)
        r26 = declare_stream()
        save(v11, r26)
        wait(250000, "q5")
        assign(v14, 0.26994654383738415)
        assign(v15, 0.5398930876747683)
        assign(v16, -0.5398930876747683)
        assign(v17, -0.26994654383738415)
        frame_rotation_2pi(v14, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v15, "q5")
        play("d_X360", "q5")
        frame_rotation_2pi(v16, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v17, "q5")
        play("d_X90", "q5")
        wait(20, "q5")
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v12, "out1"), demod.full("integW_minus_sin", v13, "out1"))
        r6 = declare_stream()
        save(v12, r6)
        r27 = declare_stream()
        save(v13, r27)
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v18, "out1"), demod.full("integW_minus_sin", v19, "out1"))
        r7 = declare_stream()
        save(v18, r7)
        r28 = declare_stream()
        save(v19, r28)
        wait(250000, "q5")
        assign(v22, 0.26994654383738415)
        assign(v23, 0.5398930876747683)
        assign(v24, -0.5398930876747683)
        assign(v25, -0.26994654383738415)
        frame_rotation_2pi(v22, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v23, "q5")
        play("d_X360", "q5")
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v20, "out1"), demod.full("integW_minus_sin", v21, "out1"))
        r8 = declare_stream()
        save(v20, r8)
        r29 = declare_stream()
        save(v21, r29)
        ...
        play("d_Y90", "q5")
        wait(20, "q5")
        assign(v28, 0.26994654383738415)
        assign(v29, 0.5398930876747683)
        assign(v30, -0.5398930876747683)
        assign(v31, -0.26994654383738415)
        frame_rotation_2pi(v28, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v29, "q5")
        play("d_X360", "q5")
        frame_rotation_2pi(v30, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v31, "q5")
        play("d_X90", "q5")
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v26, "out1"), demod.full("integW_minus_sin", v27, "out1"))
        r9 = declare_stream()
        save(v26, r9)
        r30 = declare_stream()
        save(v27, r30)
        wait(250000, "q5")
        assign(v34, 0.26994654383738415)
        assign(v35, 0.5398930876747683)
        assign(v36, -0.5398930876747683)
        assign(v37, -0.26994654383738415)
        frame_rotation_2pi(v34, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v35, "q5")
        play("d_X360", "q5")
        frame_rotation_2pi(v36, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v37, "q5")
        play("d_X90", "q5")
        wait(20, "q5")
        play("d_Y180", "q5")
        align("q5", "rr5")
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v38, "out1"), demod.full("integW_minus_sin", v39, "out1"))
        r11 = declare_stream()
        save(v38, r11)
        r32 = declare_stream()
        save(v39, r32)
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v40, "out1"), demod.full("integW_minus_sin", v41, "out1"))
        r12 = declare_stream()
        save(v40, r12)
        r33 = declare_stream()
        save(v41, r33)
        ...
        play("d_Y180", "q5")
        wait(20, "q5")
        assign(v44, 0.26994654383738415)
        assign(v45, 0.5398930876747683)
        assign(v46, -0.5398930876747683)
        assign(v47, -0.26994654383738415)
        frame_rotation_2pi(v44, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v45, "q5")
        play("d_X360", "q5")
        frame_rotation_2pi(v46, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v47, "q5")
        play("d_X90", "q5")
        align("q5", "rr5")
        wait(16, "rr5")
        ...
        save(v43, r34)
        wait(250000, "q5")
        assign(v50, 0.26994654383738415)
        assign(v51, 0.5398930876747683)
        assign(v52, -0.5398930876747683)
        assign(v53, -0.26994654383738415)
        frame_rotation_2pi(v50, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v51, "q5")
        play("d_X360", "q5")
        frame_rotation_2pi(v52, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v53, "q5")
        play("d_X90", "q5")
        wait(20, "q5")
        play("d_X180", "q5")
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v48, "out1"), demod.full("integW_minus_sin", v49, "out1"))
        r14 = declare_stream()
        save(v48, r14)
        r35 = declare_stream()
        save(v49, r35)
        ...
        play("d_X180", "q5")
        wait(20, "q5")
        assign(v56, 0.26994654383738415)
        assign(v57, 0.5398930876747683)
        assign(v58, -0.5398930876747683)
        assign(v59, -0.26994654383738415)
        frame_rotation_2pi(v56, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v57, "q5")
        play("d_X360", "q5")
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v60, "out1"), demod.full("integW_minus_sin", v61, "out1"))
        r16 = declare_stream()
        save(v60, r16)
        r37 = declare_stream()
        save(v61, r37)
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v64, "out1"), demod.full("integW_minus_sin", v65, "out1"))
        r18 = declare_stream()
        save(v64, r18)
        r39 = declare_stream()
        save(v65, r39)
        ...
        align("q5", "rr5")
        wait(16, "rr5")
        measure("readout", "rr5", None, demod.full("integW_cos", v66, "out1"), demod.full("integW_minus_sin", v67, "out1"))
        r19 = declare_stream()
        save(v66, r19)
        r40 = declare_stream()
        save(v67, r40)
        wait(250000, "q5")
        assign(v70, 0.26994654383738415)
        assign(v71, 0.5398930876747683)
        assign(v72, -0.5398930876747683)
        assign(v73, -0.26994654383738415)
        frame_rotation_2pi(v70, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v71, "q5")
        play("d_X360", "q5")
        ...
        play("d_X90", "q5")
        wait(20, "q5")
        assign(v74, 0.26994654383738415)
        assign(v75, 0.5398930876747683)
        assign(v76, -0.5398930876747683)
        assign(v77, -0.26994654383738415)
        frame_rotation_2pi(v74, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v75, "q5")
        play("d_X360", "q5")
        frame_rotation_2pi(v76, "q5")
        play("d_X180", "q5")
        frame_rotation_2pi(v77, "q5")
        play("d_X90", "q5")
        align("q5", "rr5")
        wait(16, "rr5")
...
config = {
    ...
    "controllers": {
        ...
        "con3": {
            ...
            "analog_inputs": {
                "1": {
                    "offset": 0.1504477487186405,
                    "gain_db": 20,
                },
                "2": {
                    "offset": 0.21070716967412076,
                    "gain_db": 20,
                },
            },
        },
    ...
    "waveforms": {
        ...
        "q2_d_Y360_I_wf": {
            "type": "arbitrary",
            "samples": [0.0012978722999131584, 0.0031566160897233088, 0.0067749117582842945, 0.012780278955442217, 0.021062956010198815, 0.03003612182836052, 0.036435032184826334, 0.03632084544682515, 0.027215548054471485, 0.010137964639044138] + [0.0] * 32 + [-0.010137964639044138, -0.027215548054471485, -0.03632084544682515, -0.036435032184826334, -0.03003612182836052, -0.021062956010198815, -0.012780278955442217, -0.0067749117582842945, -0.0031566160897233088, -0.0012978722999131584],
        },
        "q2_d_Y360_Q_wf": {
            "type": "arbitrary",
        ...
        "q3_d_Y360_I_wf": {
            "type": "arbitrary",
