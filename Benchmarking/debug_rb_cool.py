...
# Single QUA script generated at 2025-07-31 10:31:25.114262
...
with program() as prog:
    ...
    v5 = declare(int, )
    v6 = declare(int, )
    a5 = declare(int, size=11)
    a6 = declare(int, size=11)
    v7 = declare(int, )
            ...
            with for_(v4,0,(v4<200),(v4+1)):
                ...
                with for_(v9,0,(v9<=v1),(v9+1)):
                    with if_((a5[v9]==0), unsafe=True):
                        play("I", "q1")
                    with elif_((a5[v9]==1)):
                        play("d_X180"*amp(1), "q1")
                    with elif_((a5[v9]==2)):
                        play("d_Y180"*amp(1), "q1")
                    with elif_((a5[v9]==3)):
                        play("d_Y180"*amp(1), "q1")
                        play("d_X180"*amp(1), "q1")
                    with elif_((a5[v9]==4)):
                    ...
                    with elif_((a5[v9]==5)):
                        play("d_X90"*amp(1), "q1")
                        play("d_mY90"*amp(1), "q1")
                    with elif_((a5[v9]==6)):
                        play("d_mX90"*amp(1), "q1")
                        play("d_Y90"*amp(1), "q1")
                    with elif_((a5[v9]==7)):
                        play("d_mX90"*amp(1), "q1")
                        play("d_mY90"*amp(1), "q1")
                ...
                with for_(v10,0,(v10<=v1),(v10+1)):
                    with if_((a5[v10]==0), unsafe=True):
                        play("I", "q2")
                    with elif_((a5[v10]==1)):
                        play("d_X180"*amp(1), "q2")
                    with elif_((a5[v10]==2)):
                        play("d_Y180"*amp(1), "q2")
                    with elif_((a5[v10]==3)):
                        play("d_Y180"*amp(1), "q2")
                        play("d_X180"*amp(1), "q2")
                    with elif_((a5[v10]==4)):
                    ...
                    with elif_((a5[v10]==5)):
                        play("d_X90"*amp(1), "q2")
                        play("d_mY90"*amp(1), "q2")
                    with elif_((a5[v10]==6)):
                        play("d_mX90"*amp(1), "q2")
                        play("d_Y90"*amp(1), "q2")
                    with elif_((a5[v10]==7)):
                        play("d_mX90"*amp(1), "q2")
                        play("d_mY90"*amp(1), "q2")
                ...
                with for_(v11,0,(v11<=v1),(v11+1)):
                    with if_((a5[v11]==0), unsafe=True):
                        play("I", "q3")
                    with elif_((a5[v11]==1)):
                        play("d_X180"*amp(1), "q3")
                    with elif_((a5[v11]==2)):
                        play("d_Y180"*amp(1), "q3")
                    with elif_((a5[v11]==3)):
                        play("d_Y180"*amp(1), "q3")
                        play("d_X180"*amp(1), "q3")
                    with elif_((a5[v11]==4)):
                    ...
                    with elif_((a5[v11]==5)):
                        play("d_X90"*amp(1), "q3")
                        play("d_mY90"*amp(1), "q3")
                    with elif_((a5[v11]==6)):
                        play("d_mX90"*amp(1), "q3")
                        play("d_Y90"*amp(1), "q3")
                    with elif_((a5[v11]==7)):
                        play("d_mX90"*amp(1), "q3")
                        play("d_mY90"*amp(1), "q3")
                ...
                with for_(v12,0,(v12<=v1),(v12+1)):
                    with if_((a5[v12]==0), unsafe=True):
                        play("I", "q4")
                    with elif_((a5[v12]==1)):
                        play("d_X180"*amp(1), "q4")
                    with elif_((a5[v12]==2)):
                        play("d_Y180"*amp(1), "q4")
                    with elif_((a5[v12]==3)):
                        play("d_Y180"*amp(1), "q4")
                        play("d_X180"*amp(1), "q4")
                    with elif_((a5[v12]==4)):
                    ...
                    with elif_((a5[v12]==5)):
                        play("d_X90"*amp(1), "q4")
                        play("d_mY90"*amp(1), "q4")
                    with elif_((a5[v12]==6)):
                        play("d_mX90"*amp(1), "q4")
                        play("d_Y90"*amp(1), "q4")
                    with elif_((a5[v12]==7)):
                        play("d_mX90"*amp(1), "q4")
                        play("d_mY90"*amp(1), "q4")
                ...
                with for_(v13,0,(v13<=v1),(v13+1)):
                    with if_((a5[v13]==0), unsafe=True):
                        play("I", "q5")
                    with elif_((a5[v13]==1)):
                        play("d_X180"*amp(1), "q5")
                    with elif_((a5[v13]==2)):
                        play("d_Y180"*amp(1), "q5")
                    with elif_((a5[v13]==3)):
                        play("d_Y180"*amp(1), "q5")
                        play("d_X180"*amp(1), "q5")
                    with elif_((a5[v13]==4)):
                    ...
                    with elif_((a5[v13]==5)):
                        play("d_X90"*amp(1), "q5")
                        play("d_mY90"*amp(1), "q5")
                    with elif_((a5[v13]==6)):
                        play("d_mX90"*amp(1), "q5")
                        play("d_Y90"*amp(1), "q5")
                    with elif_((a5[v13]==7)):
                        play("d_mX90"*amp(1), "q5")
                        play("d_mY90"*amp(1), "q5")
                ...
                with for_(v14,0,(v14<=v1),(v14+1)):
                    with if_((a5[v14]==0), unsafe=True):
                        play("I", "q6")
                    with elif_((a5[v14]==1)):
                        play("d_X180"*amp(1), "q6")
                    with elif_((a5[v14]==2)):
                        play("d_Y180"*amp(1), "q6")
                    with elif_((a5[v14]==3)):
                        play("d_Y180"*amp(1), "q6")
                        play("d_X180"*amp(1), "q6")
                    with elif_((a5[v14]==4)):
                    ...
                    with elif_((a5[v14]==5)):
                        play("d_X90"*amp(1), "q6")
                        play("d_mY90"*amp(1), "q6")
                    with elif_((a5[v14]==6)):
                        play("d_mX90"*amp(1), "q6")
                        play("d_Y90"*amp(1), "q6")
                    with elif_((a5[v14]==7)):
                        play("d_mX90"*amp(1), "q6")
                        play("d_mY90"*amp(1), "q6")
    ...
    with stream_processing():
        r1.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("I1_avg")
        r2.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("Q1_avg")
        r3.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("I2_avg")
        r4.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("Q2_avg")
        r5.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("I3_avg")
        r6.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("Q3_avg")
        r7.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("I4_avg")
        r8.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("Q4_avg")
        r9.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("I5_avg")
        r10.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("Q5_avg")
        r11.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("I6_avg")
        r12.buffer(200).map(FUNCTIONS.average()).buffer(10, 10).save("Q6_avg")
...
config = {
    ...
    "controllers": {
        ...
        "con3": {
            ...
            "analog_inputs": {
                "1": {
                    "offset": 0.20547643894426118,
                    "gain_db": 20,
                },
                "2": {
                    "offset": 0.23529212659939244,
                    "gain_db": 20,
                },
            },
        },
    ...
    "waveforms": {
        ...
        "q5_d_X180_Q_wf": {
            "type": "arbitrary",
            "samples": [-0.0006019889689681309, -0.00146412560419688, -0.003142390930519528, -0.0059278458689861445, -0.009769579929280474, -0.013931581722227806, -0.01689957283218993, -0.01684660987375113, -0.012623321812408, -0.004702267612077015] + [0.0] * 32 + [0.004702267612077015, 0.012623321812408, 0.01684660987375113, 0.01689957283218993, 0.013931581722227806, 0.009769579929280474, 0.0059278458689861445, 0.003142390930519528, 0.00146412560419688, 0.0006019889689681309],
        },
        "q5_d_X90_I_wf": {
            "type": "arbitrary",
        ...
        "q5_d_X90_Q_wf": {
            "type": "arbitrary",
            "samples": [-0.00029701494629658695, -0.000722383980635725, -0.0015504222196479319, -0.0029247360220724795, -0.0048202066941679615, -0.006873694054804287, -0.008338069260292173, -0.008311937900637242, -0.006228212547853822, -0.0023200487621346643] + [0.0] * 32 + [0.0023200487621346643, 0.006228212547853822, 0.008311937900637242, 0.008338069260292173, 0.006873694054804287, 0.0048202066941679615, 0.0029247360220724795, 0.0015504222196479319, 0.000722383980635725, 0.00029701494629658695],
        },
        "q5_d_mX90_I_wf": {
            "type": "arbitrary",
            "samples": [-0.00043027546606994526, -0.0011696099806496787, -0.0028449890885206483, -0.006192488405480169, -0.012061320466190116, -0.02102178397592465, -0.032786068250465775, -0.04575664422007058, -0.05714313338354751, -0.06385854120377411] + [-0.06475165319695818] * 32 + [-0.06385854120377411, -0.05714313338354751, -0.04575664422007058, -0.032786068250465775, -0.02102178397592465, -0.012061320466190116, -0.006192488405480169, -0.0028449890885206483, -0.0011696099806496787, -0.00043027546606994526],
        ...
        "q5_d_Y180_I_wf": {
            "type": "arbitrary",
            "samples": [0.0005990152481247404, 0.0014568930782686976, 0.0031268680656667304, 0.0058985633410235045, 0.0097213199029935, 0.013862762130699742, 0.01681609188060103, 0.01676339054996865, 0.0125609647973771, 0.004679039227621396] + [0.0] * 32 + [-0.004679039227621396, -0.0125609647973771, -0.01676339054996865, -0.01681609188060103, -0.013862762130699742, -0.0097213199029935, -0.0058985633410235045, -0.0031268680656667304, -0.0014568930782686976, -0.0005990152481247404],
        },
        "q5_d_Y180_Q_wf": {
            "type": "arbitrary",
        ...
        "q5_d_Y360_I_wf": {
            "type": "arbitrary",
            "samples": [0.00016146191785773587, 0.0003926991028481114, 0.0008428334943913208, 0.0015899317298324605, 0.0026203388988172258, 0.0037366463832691323, 0.0045327033901286125, 0.004518497978923809, 0.003385752654339231, 0.0012612143844224902] + [0.0] * 32 + [-0.0012612143844224902, -0.003385752654339231, -0.004518497978923809, -0.0045327033901286125, -0.0037366463832691323, -0.0026203388988172258, -0.0015899317298324605, -0.0008428334943913208, -0.0003926991028481114, -0.00016146191785773587],
        },
        "q5_d_Y360_Q_wf": {
            "type": "arbitrary",
        ...
        "q6_d_X180_Q_wf": {
            "type": "arbitrary",
            "samples": [0.0004643370776371281, 0.001129335983534384, 0.002423846111286632, 0.004572373862940445, 0.007535650033388885, 0.010745960934883095, 0.0130352858054286, 0.012994433453288922, 0.009736850112874496, 0.0036270385568728724] + [0.0] * 76 + [-0.0036270385568728724, -0.009736850112874496, -0.012994433453288922, -0.0130352858054286, -0.010745960934883095, -0.007535650033388885, -0.004572373862940445, -0.002423846111286632, -0.001129335983534384, -0.0004643370776371281],
        },
        "q6_d_X90_I_wf": {
            "type": "arbitrary",
        ...
        "q6_d_X90_Q_wf": {
            "type": "arbitrary",
            "samples": [0.00022968111691603667, 0.0005586182163000883, 0.0011989386781383995, 0.002261693038044572, 0.0037274570559056616, 0.005315415091165435, 0.006447813770000788, 0.00642760643718163, 0.004816265417677326, 0.001794089481458803] + [0.0] * 76 + [-0.001794089481458803, -0.004816265417677326, -0.00642760643718163, -0.006447813770000788, -0.005315415091165435, -0.0037274570559056616, -0.002261693038044572, -0.0011989386781383995, -0.0005586182163000883, -0.00022968111691603667],
        },
        "q6_d_mX90_I_wf": {
            "type": "arbitrary",
            "samples": [-0.0004395104015456173, -0.0011947131379401897, -0.0029060506472970626, -0.006325396821990164, -0.012320190713369306, -0.021472971259211725, -0.033489750539301665, -0.04673871196568297, -0.058369587576938574, -0.06522912715182705] + [-0.06614140786895659] * 76 + [-0.06522912715182705, -0.058369587576938574, -0.04673871196568297, -0.033489750539301665, -0.021472971259211725, -0.012320190713369306, -0.006325396821990164, -0.0029060506472970626, -0.0011947131379401897, -0.0004395104015456173],
        ...
        "q6_d_Y180_I_wf": {
            "type": "arbitrary",
            "samples": [-0.00046528553230034477, -0.0011316427646025085, -0.0024287970580403736, -0.004581713391315702, -0.007551042348064479, -0.010767910628866824, -0.013061911673152612, -0.013020975876020588, -0.009756738597639897, -0.003634447143864112] + [0.0] * 76 + [0.003634447143864112, 0.009756738597639897, 0.013020975876020588, 0.013061911673152612, 0.010767910628866824, 0.007551042348064479, 0.004581713391315702, 0.0024287970580403736, 0.0011316427646025085, 0.00046528553230034477],
        },
        "q6_d_Y180_Q_wf": {
            "type": "arbitrary",
        ...
        "q6_d_Y90_I_wf": {
            "type": "arbitrary",
            "samples": [-0.0002296791339910079, -0.0005586133935351283, -0.0011989283272417096, -0.0022616735119825575, -0.0037274248753416304, -0.005315369201151645, -0.006447758103555601, -0.006427550945194085, -0.004816223837013796, -0.0017940739923973407] + [0.0] * 76 + [0.0017940739923973407, 0.004816223837013796, 0.006427550945194085, 0.006447758103555601, 0.005315369201151645, 0.0037274248753416304, 0.0022616735119825575, 0.0011989283272417096, 0.0005586133935351283, 0.0002296791339910079],
        },
        "q6_d_Y90_Q_wf": {
            "type": "arbitrary",
        ...
        "q6_d_Y360_I_wf": {
            "type": "arbitrary",
            "samples": [-0.0013683203547309748, -0.0033279561077994377, -0.007142651600613477, -0.013473988030287425, -0.022206245900684207, -0.03166647202322987, -0.03841271299735102, -0.038292328243120725, -0.028692798490717493, -0.010688249816314855] + [0.0] * 76 + [0.010688249816314855, 0.028692798490717493, 0.038292328243120725, 0.03841271299735102, 0.03166647202322987, 0.022206245900684207, 0.013473988030287425, 0.007142651600613477, 0.0033279561077994377, 0.0013683203547309748],
        },
        "q6_d_Y360_Q_wf": {
            "type": "arbitrary",
    ...
    "integration_weights": {
        ...
        "integW_cos_rr4": {
            "cosine": [(-0.11977296620333548, 3600)],
            "sine": [(-0.9928013076979979, 3600)],
        },
        "integW_sin_rr4": {
            "cosine": [(0.9928013076979979, 3600)],
            "sine": [(-0.11977296620333548, 3600)],
        },
        ...
        "integW_cos_rr5": {
            "cosine": [(-0.5876299213481044, 2800)],
            "sine": [(0.8091298261320123, 2800)],
        },
        "integW_sin_rr5": {
            "cosine": [(-0.8091298261320123, 2800)],
            "sine": [(-0.5876299213481044, 2800)],
        },
        ...
        "integW_cos_rr6": {
            "cosine": [(0.96971449335674, 3200)],
            "sine": [(-0.24424127696579287, 3200)],
        },
        "integW_sin_rr6": {
            "cosine": [(0.24424127696579287, 3200)],
            "sine": [(0.96971449335674, 3200)],
        },
