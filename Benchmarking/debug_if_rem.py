...
# Single QUA script generated at 2025-07-20 12:39:11.680654
...
with program() as prog:
    ...
    with for_(v3,0,(v3<10),(v3+1)):
        ...
        with for_(v1,1,(v1<=50),(v1+1)):
            with for_(v4,0,(v4<200),(v4+1)):
                ...
                align("q12_2", "rr2")
                wait(4, "rr2")
                measure("readout", "rr2", None, demod.full("integW_cos", a1[0], "out2"), demod.full("integW_minus_sin", a2[0], "out2"))
                r1 = declare_stream()
                save(a1[0], r1)
                r2 = declare_stream()
                save(a2[0], r2)
    ...
    with stream_processing():
        r1.buffer(200).map(FUNCTIONS.average()).buffer(10, 50).save("I2_avg")
        r2.buffer(200).map(FUNCTIONS.average()).buffer(10, 50).save("Q2_avg")
