...
# Single QUA script generated at 2025-07-20 11:28:34.031391
...
with program() as prog:
    ...
    v5 = declare(int, )
    v6 = declare(int, )
    a5 = declare(int, size=201)
    a6 = declare(int, size=201)
    v7 = declare(int, )
    ...
    with stream_processing():
        r1.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("I1_avg")
        r2.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("Q1_avg")
        r3.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("I2_avg")
        r4.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("Q2_avg")
        r5.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("I3_avg")
        r6.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("Q3_avg")
        r7.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("I4_avg")
        r8.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("Q4_avg")
        r9.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("I5_avg")
        r10.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("Q5_avg")
        r11.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("I6_avg")
        r12.buffer(3).map(FUNCTIONS.average()).buffer(10, 200).save("Q6_avg")
    ...
    #
    # Trace:
    #   ['qm.exceptions.QmQuaException: Could not find location\n']
    #
    ################################################
