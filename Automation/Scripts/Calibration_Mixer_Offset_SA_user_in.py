...
LO_device = rm.open_resource(LO_IP_dict[f'{q_no[0:-1]}_LO'][f'{((q_n-1) // 2)+1}'])
LO_freq_val = LO_device.query_ascii_values('SOUR:FREQ:CW?')[0]
...
center_freq = LO_freq_val
span = 50 #MHz
calib.set_bandwidth(5) #KHz
